...
#pragma main
    ...
    num_f = stringTointVector(txt_f);
    num_b = stringTointVector(txt_b);
    int ans = s.numOfUnplacedFruits(num_f, num_b);
    // debug(num_f, txt_f, txt_b);
    debug(ans, num_f, num_b, txt_f, txt_b);
    outputln(ans);
