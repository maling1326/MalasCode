...
public:
    int possibleStringCount(string word) 
    {
        ...
        // searching per multiple character
        // if the character is single than 0
        // if the character have more than 1 then 1 or 2 or 3 etc
        // and adding it into the result integer
        // but if there is none character that have more then 1 multiple character
        // then the result was itself (1)
        int result = 1;
        char behind = '\0';
        for (char c : word) 
        {
